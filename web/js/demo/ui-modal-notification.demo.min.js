...
var handleGritterNotification = function () {
    ...
    handleSweetNotification = function () {
        $('[data-click="swal-primary"]').click(function (e) {
            ...
            $('[data-click="swal-dangerPrinter"]').click(function (e) {
                    e.preventDefault(), swal({
                        title: 'Are you sure?',
                        text: 'You will not be able to recover this printer information!',
                        icon: 'error',
                        buttons: true,
                        dangerMode: true,
                        ...
                        .then((willDelete) => {
                            if (willDelete) {
                                swal("Deleted!", "Printer information has been deleted.", "success")
                                    .then(() => {
                                        //redirect to delete page complete with arguments to the method
                                        id = document.getElementById("printerId").value;
                                        window.location.pathname = 'printer/delete/' + id;
                                    });
                            }
                        });
                }
            )
        $('[data-click="swal-dangerModel"]').click(function (e) {
                e.preventDefault(), swal({
                    title: 'Are you sure?',
                    text: 'You will not be able to recover this model information!',
                    icon: 'error',
                    buttons: true,
                    dangerMode: true,
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            swal("Deleted!", "Model information has been deleted.", "success")
                                .then(() => {
                                    //redirect to delete page complete with arguments to the method
                                    id = document.getElementById("modelId").value;
                                    window.location.pathname = 'model/delete/' + id;
                                });
                        }
                    });
            }
        )
        $('[data-click="swal-dangerCompany"]').click(function (e) {
                e.preventDefault(), swal({
                    title: 'Are you sure?',
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            swal("Deleted!", "Company information has been deleted.", "success")
                                .then(() => {
                                    //redirect to delete page complete with arguments to the method
                                    id = document.getElementById("companyId").value;
                                    window.location.pathname = 'company/delete/' + id;
                                });
                        }
                    });
            }
